        ...
        <div className='text-center text-3xl font-bold text-white'>
            ...
            <div className="login-btns">
                <div className="flex flex-col gap-2 min-h-screen p-10 items-center ">
                    <button
                        className="flex items-center bg-slate-300 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
